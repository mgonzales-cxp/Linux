...
# Update Mint
	...
	echo -e "### $COL_RED dist-upgrade. This can take 30 minutes or more. $COL_RESET"
...
# Installs
	...
	if [[ "$?" == "0" ]]; then
		...
		gdebi -n /home/tech/Downloads/ctxusb_2.4.285639_i386.deb &>/dev/null
		gdebi -n /home/tech/Downloads/icaclient_13.1.0.285639_i386.deb &>/dev/null
	fi
...
# Remove initial_setup.sh from desktop
	...
	rm /home/tech/Desktop/initial_train_setup.sh &>/dev/null
