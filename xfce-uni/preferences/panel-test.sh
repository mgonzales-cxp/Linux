  ...
  <property name="plugins" type="empty">
    ...
    <property name="plugin-2" type="string" value="launcher">
      <property name="items" type="array">
        <value type="string" value="14309475482.desktop"/>
      </property>
...
</channel>' > $1/.config/xfce4/xfconf/xfce-perchannel-xml/xfce4-panel.xml

cp -r /usr/src/IT_Files/Linux/xfce-uni/preferences/launcher-2 $1/.config/xfce4/panel
