   ...
   "roots": {
      "bookmark_bar": {
         "children": [ {
            ...
            "name": "CallPro XE",
            "type": "url",
            "url": "callproxe-cvty-train-web1.connexionpoint.com/cti/agents/"
         }, {
            ...
            "id": "14",
            "name": "Aetna Medicare: Home",
            "type": "url",
            "url": "www.aetnamedicare.com"
         }, ],
...
echo '{
   ...
   "session": {
      ...
      "startup_urls": [ "callproxe-cvty-train-web1.connexionpoint.com/cti/agents/" ],
