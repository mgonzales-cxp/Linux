...
function LivePerson()
	{
		# Install LivePerson
		#wine /usr/src/IT_Files/Linux/xfce-test/software/LPAC_WIN.exe
		echo ""
		echo "### Install LivePerson by entering into a new terminal: "
		echo ""
		echo "wine /usr/src/IT_Files/Linux/xfce-test/software/LPAC_WIN.exe"
		echo ""
...
Exec=wine "/home/'$1'/.wine/drive_c/Program Files (x86)/LivePersonAgent/LivePerson.exe"
Icon=/usr/src/IT_Files/Linux/xfce-test/preferences/DesktopShortcut.png
Path=/home/'$1'/.wine/dosdevices/c:/Program Files (x86)/LivePersonAgent/
Terminal=false
StartupNotify=true' > /home/$1/Desktop/LivePerson.desktop
		chmod +x /home/$1/Desktop/LivePerson.desktop
