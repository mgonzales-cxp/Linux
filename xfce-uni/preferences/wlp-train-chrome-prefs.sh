...
echo '{
   ...
   "roots": {
      "bookmark_bar": {
         "children": [ {
            ...
            "id": "7",
            "name": "Training Siebel",
            "type": "url",
            "url": "javascript:window.open(\"http://siebel.perf.va.wellpoint.com\")"
         }, {
            "date_added": "13068597805116425",
            "id": "8",
            "name": "Training Citrix",
            "type": "url",
            "url": "Https:// extcitrix.wellpoint.com/vpn/index.html"
         },  {
   ...
   "version": 1
}' > /home/anthem-training/.config/google-chrome/Default/Bookmarks
...
echo '{
   ...
   "session": {
      ...
      "startup_urls": [ "callproxe-tls-train-web1.connexionpoint.com/cti/agents" ],
...
}' > /home/anthem-training/.config/google-chrome/Default/Preferences
echo "Write operation completed!"
