...
### INITIAL SETUP ###
	...
	echo "This MUST be run under sudo su. If this isn't the case, please press CTRL+C to cancel and re-run under sudo su."	
	sleep 3
...
# Update Mint
	...
	apt-get purge firefox gimp gthumb hexchat libreoffice-draw thunderbird transmission-* pidgin banshee brasero totem -y
	#apt-get dist-upgrade -y #(when prompted, enter 'y' for the new package)
	
	# dist-upgrade with no prompts
	echo -e "### $COL_RED dist-upgrade. This will take several minutes... $COL_RESET"
...
# Mounts
	...
	echo "//hal2.connexionpoint.com/IT_Files /usr/src/IT_Files cifs guest,uid=1000,iocharset=utf8  0  0" >> /etc/fstab
...
# Installs
	...
	apt-get install vim openssh-server build-essential clamav x11vnc libxerces-c3.1 qpdfview wine1.7 opera xclip -y #sflphone-gnome google-chrome-stable 
	
	echo ""
	echo "### Copying Downloads..."
	echo ""
	
	cp -a /usr/src/IT_Files/Linux/software/* /home/tech/Downloads
	...
	if [[ "$?" == "0" ]]; then
		...
		gdebi -n /home/tech/Downloads/icaclient_13.1.0.285639_amd64.deb
		gdebi -n /home/tech/Downloads/ctxusb_2.4.285639_amd64.deb
	elif [[ "$?" == "1" ]]; then
		gdebi -n /home/tech/Downloads/ctxusb_2.4.285639_i386.deb
		gdebi -n /home/tech/Downloads/icaclient_13.1.0.285639_i386.deb
	fi
	chmod a+x /home/tech/Downloads/Zoiper_3.3_Linux_Free_32Bit.run
	/home/tech/Downloads/Zoiper_3.3_Linux_Free_32Bit.run --mode unattended --unattendedmodeui minimal
	rm /usr/share/Zoiper/SkinRoundV2.zss /usr/share/Zoiper/SkinSilver.zss /usr/share/Zoiper/SkinSleek.zss
	rm /home/tech/Desktop/Zoiper.desktop
	touch /etc/udev/rules.d/70-u2f.rules
	
	# Install AlienVault
	if [ ! -f /var/log/alienv.log ]; then
		echo ""
		echo "### Installing AlienVault..."
		echo ""

		/usr/src/IT_Files/Linux/software/other/ossec-hids-2.8.1/install.sh
	fi
...
LABEL="u2f_end"' > /etc/udev/rules.d/70-u2f.rules &>/dev/null
...
#	echo 'set superusers="tech"
#password_pbkdf2 tech
#grub.pbkdf2.sha512.10000.EE82BF62EC4532F87204E4063BF72775EFA16D7D219ACFD953E4AD331E1C395C3699BF0E3E37B1B255F24353598228A72D0B0BC3F36BA7EB43D8E61E77C0DF1C.0467C996E893DCC161DB99FF8B14151C0D6FEBDA74B12FAA426192F1A5FFC72AD39645D24AAD2C248974111C38589140E8259BEBEC78BC9A02F6B1FFC7BD2713'	>> /etc/grub.d/40_custom

# Update BASH

	cp /usr/src/IT_Files/Linux/xfce-uni/preferences/bash.bashrc /etc/ &>/dev/null

# Post-install dist-upgrade
